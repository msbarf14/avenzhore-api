        ...
        <div class="row">
          <div class="col-8">
            <div class="form-group">
              <label >Title*</label>
              <input type="text" name="title" class="form-control" value="{{old('text', $post->title)}}">
            </div>
            <div class="form-group">
              <label >Content*</label>
              <textarea name="content" id="mytextarea" style="min-height: 70vh">{{old('content', $post->content)}}</textarea>
            </div>
          </div>
          <div class="col-4">
            ...
            <div class="input-group  form-group mb-3">
              <input id="thumbnail" class="form-control" type="text" name="picture" placeholder="Image" value="{{$post->picture}}">
            ...
            <div class="form-group">
             ...
             <textarea name="picture_description" class="form-control">{{$post->picture_description}}</textarea>
            </div>
          </div>
        </div>
