        ...
        <div class="form-group">
         ...
         <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control form-control-lg"  name="synopsis" value="{{old('synopsis')}}"> 
          </div>
           <!-- synopsis -->
           <div class="form-group">
            <label for="inputName">Deskripsi</label>
            <textarea name="des" id="mytextarea" style="min-height: 70vh">{{old('des')}}</textarea>
          </div>
        <!-- image -->
        <label>Image</label>
